...
(str_contains($interrupt, '<li>one</li>') && str_contains($interrupt, '<li>two</li>'))
    || fail('list-interrupts-paragraph failed: ' . $interrupt);
...
/* ----- TASK 2: 50k-iteration leak sanity ----- */
echo "[TASK 2] 50,000-iteration leak loop\n";
...
/* ----- TASK 3: batch parity ----- */
echo "[TASK 3] FfiBatchParser parity (100 docs)\n";
